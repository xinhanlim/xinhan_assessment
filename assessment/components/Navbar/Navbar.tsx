...
export default function Navbar() {
    ...
    return (
        <>
            <nav className="sticky top-0 z-998 flex justify-center justify-center items-center px-[5%]">
                <div className="w-[1520px] flex flex-row">
                    <div className="w-full flex flex-row justify-between py-4 ">
                        ...
                        <button type="button"
                            ...
                            className=" relative overflow-hidden flex items-center justify-center md:hidden px-[5%]"
                        >
