...
export default function Features() {
    return (
        <section id="features" className="flex justify-center px-[5%] w-full h-full flex-col items-center   ">
            <div className="flex flex-col sm:flex-row w-full xl:w-[1520px] sm:h-screen flex py-[60px] md:pt-[150px] justify-between ">
                <div className="flex flex-col gap-[60px] w-full h-full">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between gap-8 md:gap-[120px]">
                        ...
                        <div className="w-full h-full">
                            <ul className="flex flex-col justify-between h-full tracking-tighter leading-none">
                                <li className="py-8 md:pb-8 md:pt-0 flex flex-row gap-2 ">
            ...
            <div className="flex flex-col sm:flex-row w-full xl:w-[1520px] sm:h-screen flex py-[60px] justify-between ">
                <div className="flex flex-col gap-[60px] w-full h-full">
                    ...
                    <div className="flex flex-col-reverse sm:flex-row justify-between gap-[60px]">
                        ...
                        <div className="relative w-full h-[500px] overflow-hidden border-1 border-white py-8 px-8 videoBg ">
                            <Image src="/images/functions/mobile-2-new.png" alt="function1" fill className="w-full h-full object-contain" />
                        </div>
                    </div>
                </div>
            </div>
